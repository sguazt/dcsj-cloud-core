 ...
 */
public class TestMiniCloudRawSocketServiceScheduler
{
	private static final transient Logger Log = Logger.getLogger( TestMiniCloudRawSocketServiceScheduler.class.getName() );
				...
				new Runnable()
				{
					public void run()
					{
						try
						{
							...
							TestMiniCloudRawSocketServiceScheduler.this.schedServer.start();
						}
						catch (Exception e)
						{
	...
	public void testIsRunning() throws Exception
	{
		...
		RawSocketServiceScheduler schedClient = new RawSocketServiceScheduler( this.schedServer.getPort() );
	...
	{
		org.junit.runner.JUnitCore.main( TestMiniCloudRawSocketServiceScheduler.class.getName() );
	}
}
