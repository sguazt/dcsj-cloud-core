 ...
 */
public interface IServiceProberStats
{
	ExecutionStatus getExecutionStatus();

	IHostPingerStats getHostPingStats();

	Collection<IInetServiceStats> getServiceStats();

	IInetServiceStats getServiceStats(InetProtocol proto, int port);
}
